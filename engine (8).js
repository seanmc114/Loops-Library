...
(function () {
  ...
  var CATEGORY_COLORS = {
    "Language": { pastel: "#8FE3D8", deep: "#2FB18A" },
    "Onboarding": { pastel: "#F8CE7C", deep: "#D9A03F" },
    "Compliance": { pastel: "#A9C6EE", deep: "#4F7FC7" },
    "Exam Prep": { pastel: "#CBB9F5", deep: "#8B67D9" },
    "Misc": { pastel: "#F5AD92", deep: "#E0784E" },
    "Legacy": { pastel: "#B5CC8E", deep: "#7DA355" }
  };
  ...
  function injectStyles() {
    ...
    var css = "" +
      "#loopsApp{--navy:#0D2A52;--cat:" + cat.pastel + ";--catDeep:" + cat.deep + ";--amber:" + AMBER + ";--ink:#0D2A52;--red:#c94c4c;" +
      ...
      "background:var(--cat);border-radius:20px;}" +
      ...
      ".loops-hint{background:#fffbea;border:1px solid var(--amber);border-radius:10px;padding:10px;font-size:.85rem;margin-bottom:10px;}" +
